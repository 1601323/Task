...
bool GameClear::init()
{
	...
	// 通常時,押した時
	// 押した時のｱｸｼｮﾝ
	auto startButton = MenuItemImage::create("CloseNormal.png", "CloseSelected.png", CC_CALLBACK_1(GameClear::pushStart, this));
...
// 背景
void GameClear::ClearBackGroudn()
{
	// 画面サイズ取得
	...
	// タイトル配置
	// 配置文字
	auto lbl_Select = Label::createWithSystemFont("Clear", "HiraKakuProN-W6", 100);
	// 配置場所
